...
// // // // // UPDATED: Now handles the full two-step OTP registration and verification process.
...
// // // // const UserIcon = () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></svg>;
// // // // const EmailIcon = () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path d="M2.003 5.884L10 2l7.997 3.884A2 2 0 0019 7.616V16a2 2 0 01-2 2H3a2 2 0 01-2-2V7.616a2 2 0 001.003-1.732zM10 4.218L4.218 7 10 9.782 15.782 7 10 4.218zM4 16V9.218l6 2.909 6-2.909V16H4z" /></svg>;
// // // // const LockIcon = () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>;
...
// // // //     const [otpSent, setOtpSent] = useState(false); // New state to track UI step
...
// // // //             setOtpSent(true); // Switch to the OTP verification view
// // // //         } catch (err) {
...
// // // //                             <div className="relative"><div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><EmailIcon /></div><input className={inputBaseStyle} name="email" type="email" placeholder="Email Address *" onChange={handleChange} /></div>
// // // //                             <div className="relative"><div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><UserIcon /></div><input className={inputBaseStyle} name="fullName" placeholder="Full Name *" onChange={handleChange} /></div>
// // // //                             <div className="relative"><div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><LockIcon /></div><input className={inputBaseStyle} name="password" type="password" placeholder="Password *" onChange={handleChange} /></div>
// // // //                             <div className="relative"><div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><LockIcon /></div><input className={inputBaseStyle} name="confirmPassword" type="password" placeholder="Confirm Password *" onChange={handleChange} /></div>
...
// // // //                             <div className="relative"><div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><LockIcon /></div><input className={inputBaseStyle} name="otp" placeholder="Enter 6-Digit OTP" value={otp} onChange={(e) => setOtp(e.target.value)} /></div>
...
// // // // File: src/components/RegisterModal.jsx
// // // // UPDATED: This is the complete, correct version with email, OTP, and autosuggest features.
...
// // // const LockIcon = () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>;
// // // const SpinnerIcon = () => <svg className="animate-spin h-5 w-5 text-white" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>;
// // // const DepartmentIcon = () => <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 11-2 0V4H6a1 1 0 11-2 0V4zm4 2a1 1 0 011 1v1a1 1 0 11-2 0V7a1 1 0 011-1zm3 0a1 1 0 011 1v1a1 1 0 11-2 0V7a1 1 0 011-1zm-3 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zm3 0a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1z" clipRule="evenodd" /></svg>;
...
// // //                                 <input className={inputBaseStyle} name="fullName" placeholder="Full Name *" value={formData.fullName} onChange={e => setFormData({...formData, fullName: e.target.value})} />
// // //                             </div>
// // //                             <div className="relative">
...
// // //                                 <input className={inputBaseStyle} name="password" type="password" placeholder="Password *" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} />
// // //                             </div>
// // //                             <div className="relative">
// // //                                 <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><LockIcon /></div>
// // //                                 <input className={inputBaseStyle} name="confirmPassword" type="password" placeholder="Confirm Password *" value={formData.confirmPassword} onChange={e => setFormData({...formData, confirmPassword: e.target.value})} />
// // //                             </div>
// // //                             <button type="submit" className="flex items-center justify-center w-full px-4 py-2 font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:opacity-50" disabled={loading}>
// // //                                 {loading ? <SpinnerIcon /> : 'Get Verification Code'}
// // //                             </button>
...
// // // export default RegisterModal;
// // // File: src/components/RegisterModal.jsx
// // // This is the complete, correct version of the RegisterModal.
...
// // Dummy services (safe fallbacks so it won't crash)
// const authService = {
//   requestOtp: async () => Promise.resolve(),
//   verifyOtpAndRegister: async () => Promise.resolve(),
// };

// const masterDataService = {
//   getDepartments: async () =>
//     Promise.resolve({ data: [{ name: "IT" }, { name: "HR" }, { name: "Admin" }] }),
// };

// // Temporary placeholder (remove when your real component is ready)
...
// const EmailIcon = () => (
//   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
//     <path d="M2.003 5.884L10 2l7.997 3.884A2 2 0 0019 7.616V16a2 2 0 01-2 2H3a2 2 0 01-2-2V7.616a2 2 0 001.003-1.732zM10 4.218L4.218 7 10 9.782 15.782 7 10 4.218zM4 16V9.218l6 2.909 6-2.909V16H4z" />
//   </svg>
// );
// const LockIcon = () => (
//   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
...
//   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
//     <path fillRule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 11-2 0V4H6a1 1 0 11-2 0V4zm4 2a1 1 0 011 1v1a1 1 0 11-2 0V7a1 1 0 011-1zm3 0a1 1 0 011 1v1a1 1 0 11-2 0V7a1 1 0 011-1zm-3 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zm3 0a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1z" clipRule="evenodd" />
//   </svg>
// );
...
//                       <li key={s} onClick={() => selectSuggestion("email", s)} className="px-4 py-2 cursor-pointer hover:bg-gray-100">{s}</li>
//                     ))}
//                   </ul>
//                 )}
//               </div>
...
//                       <li key={s} onClick={() => selectSuggestion("department", s)} className="px-4 py-2 cursor-pointer hover:bg-gray-100">{s}</li>
//                     ))}
//                   </ul>
//                 )}
//               </div>
