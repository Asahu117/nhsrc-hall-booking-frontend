...
// // // //               src="/public/assets/images/login/nhscr-logo_1.png" 
// // // //               alt="NHSRC Logo" 
// // // //             />
...
// // // UPDATED: This version correctly includes and uses the onSignUpClick prop.
...
// //         <div className="flex items-center justify-between">
// //           <Link to={user ? "/home" : "/"} className="flex items-center space-x-3">
// //             <img className="h-12 w-auto" src="[https://www.nhsrcindia.org/sites/default/files/2022-01/NHSRC_SA_EN_Colour_0.png](https://www.nhsrcindia.org/sites/default/files/2022-01/NHSRC_SA_EN_Colour_0.png)" alt="NHSRC Logo" />
// //             <span className="hidden sm:inline text-xl font-bold text-gray-800">NHSRC Booking</span>
// //           </Link>
// //           <div className="flex items-center space-x-4">
// //             {user ? (
