...
// // SVG Icon Components (black color)
// const UserIcon = () => (
...
// const EyeOffIcon = () => (
//   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-black" viewBox="0 0 20 20" fill="currentColor">
//     <path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.477 4 12 4a4.995 4.995 0 00-2.523.634l-1.78-1.781zm4.418 4.418A4 4 0 0010 14a4 4 0 004-4c0-.773-.22-1.5-.6-2.121L12.121 9.4A2 2 0 0010 12a2 2 0 00-2-2c.105 0 .208.015.307.042l-1.18 1.178z" clipRule="evenodd" />
//     <path d="M12.121 9.4A2 2 0 0010 12a2 2 0 00-2-2c.105 0 .208.015.307.042l-1.18 1.178A4 4 0 004 10a4 4 0 004 4c.773 0 1.5-.22 2.121-.6l1.414 1.414a6.01 6.01 0 01-4.135.397 10.02 10.02 0 01-8.204-5.022C.458 10 3.732 4.943 7.523 3a10.02 10.02 0 015.204 1.397l-1.616 1.616z" />
//   </svg>
// );
...
//     const inputBaseStyle = "w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white bg-opacity-75 backdrop-blur-sm transition-colors";
