...
// // Purpose: New component to show a user-friendly 404 page.
...
//         <Link 
//             to="/dashboard" // Or a dynamic home route based on role
//             className="px-6 py-2 mt-6 text-sm font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700"
//         >
//             Go to Dashboard
//         </Link>
//     </div>
